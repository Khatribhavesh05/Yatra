...
/**
 * Yatra brand logo as an inline SVG component for the public citizen portal.
 * Variants:
 ...
 */
export const YatraLogo: React.FC<YatraLogoProps> = ({ variant = 'full', className = '', height = 36 }) => {
  if (variant === 'icon') {
    const size = height;
    return (
      <svg
  ...
  const tagline = isDark ? 'यात्रा — Smart Mobility' : 'यात्रा — Smart Mobility for Everyone';
  const w = height * 3.6;
